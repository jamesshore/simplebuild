	...
	describe("Type", function() {
		...
		describe("describer", function() {
			...
			it ("describes 'structs'", function() {
				assert.equal(describe({}), "object matching {}", "empty object");
				assert.equal(describe({ a: Number }), "object matching { a: number }", "one parameter");
				assert.equal(describe({ a: Number, b: String }), "object matching { a: number, b: string }");
			});
