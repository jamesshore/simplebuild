...
describe("Ensure", function() {
	...
	describe("signature checking", function() {
		...
		it("checks no arguments", function() {
			...
			assert.exception(signature([ "foo" ]), /Function called with too many arguments: expected 0 but got 1/);
		});
		...
		it("allows optional arguments", function() {
			...
			assert.exception(
				...
				/Argument #1 expected undefined, or Object instance, but was string/,
